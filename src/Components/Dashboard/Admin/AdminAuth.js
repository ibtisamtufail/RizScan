        ...
        <section className='option-parent'>
          ...
          >
            <section style={{ display: 'flex', justifyContent: 'center', width: '350px' }}>
              <FormControlLabel onChange={() => setOption(1)} value="female" control={<Radio />} label="Admin" />
              <FormControlLabel onChange={() => setOption(2)} value="male" control={<Radio />} label="Admin User" />
            </section>
          </RadioGroup>
        </section>
